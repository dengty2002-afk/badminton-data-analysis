...
SOURCE = ROOT / "research_outputs" / "shi_player_profile_submission_v1" / "SUBMISSION_MANUSCRIPT_CONTENT_v1.md"
OUT_DIR = ROOT / "output" / "pdf" / "shi_player_profile_submission_v1"
TEX = OUT_DIR / "shi_player_profile_submission_v1.tex"


CITATIONS = [
    (r"Phomsoupha和Laffaye（2015）", r"\citet{Phomsoupha2015}"),
    (r"Laffaye et al., 2015", r"\citep{Laffaye2015}"),
    (r"Gómez等人（2019）", r"\citet{Gomez2019}"),
    (r"Gomez等人（2020）", r"\citet{Gomez2020}"),
...
\hypersetup{colorlinks=true,linkcolor=black,citecolor=black,urlcolor=blue,pdftitle={基于自动逐拍数据的石宇奇男子单打打法结构与技战术过程代理画像}}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small 石宇奇男子单打打法结构与技战术过程代理画像}
...
\centering
\vspace*{2.2cm}
{\LARGE\bfseries 基于自动逐拍数据的石宇奇男子单打打法结构与技战术过程代理画像\par}
\vspace{0.5cm}
{\Large 24场比赛的回顾性个案研究\par}
\vspace{1.0cm}
{\large\itshape Playing-Style Structure and Tactical-Process Proxy Profile of Shi Yuqi:\par}
{\large\itshape A 24-Match Stroke-Level Case Study\par}
\vfill
{\large 内容投稿版\par}
\vspace{0.4cm}
{\normalsize 探索性回顾性个案研究\par}
\vfill
{\large 2026年8月24日\par}
\end{titlepage}
"""
